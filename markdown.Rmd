...
sigma_big2 <- matrix(0, nrow=nrow(X.train),ncol=nrow(X.train))
for (i in seq(1,nrow(X.train), by=4)){
sigma_big[i:(i+3), i:(i+3)] <- inv_cor_mat
sigma_big2[i:(i+3), i:(i+3)] <- cor_mat
}
...
#sel_nm <- c('DPSUTOFP','DPSTURNR','DPSTBLFP','DPSTO2FP','DPFRAFEDP','DPFUNAB1T','DPFUNA4T','DPFPACOMP','DPFPABILP','DPFPREKP','DPFPAOTHP','a1_ethi_d_pct','a1_etha_d_pct','a1_ethb_d_pct','a1_ethw_d_pct','a1_eth2_d_pct','a1_eco2_d_pct','a1_ti17_d_pct','a1_migy_d_pct','a1_bil2_d_pct','a1_esl2_d_pct','a1_esl3_d_pct','a1_gify_d_pct','a1_atry_d_pct','a1_voc2_d_pct')
